...
fn qr_engine_js() -> String {
  string_join(
    [
      ...
      "    return `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 ${view} ${view}' width='${view * scale}' height='${view * scale}' role='img' aria-label='QR code'><rect width='100%' height='100%' fill='#fff'/><path fill='#111' d='${path.join('')}'/></svg>`;",
      "  }",
      "",
      "  function make(text) {",
